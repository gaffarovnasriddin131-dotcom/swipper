...
export default function About() {
  ...
  const text = {
    ...
    storeTitle: uz ? "iStore nima?" : "What is iStore?",

    storeText: uz
      ? "iStore — Apple mahsulotlarini bir joyda ko‘rish, mahsulotlar haqida ma’lumot olish va kerakli mahsulotga buyurtma berish uchun yaratilgan zamonaviy onlayn do‘kon."
      : "iStore is a modern online store created to view Apple products in one place, learn more about them and order the product you need.",

    whyTitle: uz ? "Nima uchun yaratilgan?" : "Why was it created?",
    ...
    whatTitle: uz ? "Saytda nimalar qilish mumkin?" : "What can you do on the website?",
    ...
    viewTitle: uz ? "Mahsulotlarni ko‘rish" : "View Products",
    ...
    chooseTitle: uz ? "Mahsulot tanlash" : "Choose a Product",
    ...
    orderTitle: uz ? "Buyurtma berish" : "Place an Order",
    ...
    processTitle: uz ? "Buyurtma jarayoni" : "Order Process",
    ...
    step1: uz ? "Buyurtmangiz qabul qilinadi." : "Your order is received.",
    step2: uz ? "Buyurtma ma’lumotlari tekshiriladi." : "Your order information is checked.",
    step3: uz ? "Buyurtmani tasdiqlash uchun siz bilan bog‘laniladi." : "We contact you to confirm your order.",
    step4: uz ? "Yetkazib berish tafsilotlari aniqlashtiriladi." : "Delivery details are clarified.",
    ...
    trackButton: uz ? "Buyurtmamni kuzatish" : "Track My Order",
  };
  ...
  return (
    <section className="relative min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white transition-colors duration-300 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="fade-up-delay-1 group relative p-8 md:p-10 rounded-[32px] bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 overflow-hidden">
            ...
            <h2 className="relative text-3xl font-black mb-5">{text.storeTitle}</h2>
            <p className="relative text-gray-500 dark:text-gray-400 text-lg leading-8">{text.storeText}</p>
          </div>
          ...
          <div className="fade-up-delay-2 group relative p-8 md:p-10 rounded-[32px] bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 overflow-hidden">
            ...
            <h2 className="relative text-3xl font-black mb-5">{text.whyTitle}</h2>
            <p className="relative text-gray-500 dark:text-gray-400 text-lg leading-8">{text.whyText}</p>
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10 fade-up">
            <p className="text-sm font-bold tracking-[3px] text-gray-400 uppercase mb-4">iStore</p>
            <h2 className="text-4xl md:text-5xl font-black mb-5">{text.whatTitle}</h2>
            <p className="text-gray-500 dark:text-gray-400 text-lg leading-8">{text.whatText}</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400 leading-7">{item.desc}</p>
              </div>
            ))}
        ...
        <div className="fade-up relative rounded-[40px] bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-8 md:p-14 overflow-hidden">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="text-sm font-bold tracking-[3px] text-gray-400 uppercase mb-4">{text.processTitle}</p>
            <h2 className="text-4xl md:text-5xl font-black mb-6">{text.afterTitle}</h2>
            <p className="text-gray-500 dark:text-gray-400 text-lg leading-8 mb-8">{text.afterText}</p>

            <div className="space-y-4">
              {[text.step1, text.step2, text.step3, text.step4].map((step, i) => (
                <div key={i} className="step-slide flex items-start gap-4" style={{ animationDelay: `${i * 120}ms` }}>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 pt-1.5">{step}</p>
                </div>
              ))}
            </div>
        ...
        <div className="fade-up group relative mt-8 rounded-[40px] bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-8 md:p-14 overflow-hidden" style={{ animationDelay: "150ms" }}>
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-4">{text.trackTitle}</h2>
              <p className="text-gray-500 dark:text-gray-400 text-lg leading-8">{text.trackText}</p>
            </div>
      ...
      <style>{`
        ...
        .fade-up-delay-1 { animation: fadeUp 0.8s ease-out 0.1s both; }
        .fade-up-delay-2 { animation: fadeUp 0.8s ease-out 0.25s both; }

        @keyframes stepSlide {
          from { opacity: 0; transform: translateX(-20px); }
          to { opacity: 1; transform: translateX(0); }
        }
        .step-slide { animation: stepSlide 0.6s ease-out both; }

        @keyframes float {
          0%, 100% { transform: translate(0, 0) scale(1); }
          50% { transform: translate(30px, -30px) scale(1.05); }
        }
        .floating-blob { animation: float 12s ease-in-out infinite; }
        .floating-blob-delayed { animation: float 15s ease-in-out infinite; animation-delay: -5s; }
        ...
        .apple-spin { animation: appleSpin 4s ease-in-out infinite; }
        ...
        .dark .pulse-ring { animation: pulseRingDark 2.5s ease-out infinite; }
