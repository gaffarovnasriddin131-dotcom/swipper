        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="w-14 h-14 rounded-2xl bg-blue-600 text-white flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
              ...
              <div>
                ...
                <h3 className="text-lg font-black text-gray-900 group-hover:text-blue-600 transition">
                  +998 93 035 11 17
                </h3>
            ...
            <div className="mt-6 flex items-center justify-between text-blue-600 font-bold">
          ...
          >
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="w-14 h-14 rounded-2xl bg-sky-500 text-white flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
              ...
              <div>
                ...
                <h3 className="text-lg font-black text-gray-900 group-hover:text-sky-500 transition">
                  @Gaffarov_11
                </h3>
            ...
            <div className="mt-6 flex items-center justify-between text-sky-500 font-bold">
